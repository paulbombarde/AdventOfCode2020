...
sorted_allergen_to_ingredient = sorted(allergen_to_ingredient.items(), key=lambda x : x[0])
print(sorted_allergen_to_ingredient)
print(','.join(i for a,i in sorted_allergen_to_ingredient))
